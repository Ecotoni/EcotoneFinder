                                     ...
                                     x.range, z.range)
{
  ...
  graphics::legend("bottomright",
                   legend = c("normalized partition coefficient (PCN)",
                              "normalized partition entropy (PEN)"),
                   col = c("red", "blue"),
                   lty = 1)
}
...
#'
#' @return A clustergram plot and a fuzzy indices evolution plot of the imputed
#'   data
#'
#' @export
#'
